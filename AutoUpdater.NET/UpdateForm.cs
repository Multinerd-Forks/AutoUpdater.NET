...
namespace AutoUpdaterDotNET
{
	internal partial class UpdateForm : Form
	{
		...
		private void ButtonUpdateClick(object sender, EventArgs e)
		{
			...
			{
				if (AutoUpdater.DownloadUpdate()) DialogResult = DialogResult.OK;
			}
		}
		...
		private void UpdateForm_FormClosed(object sender, FormClosedEventArgs e) { AutoUpdater.Running = false; }
	}
}
