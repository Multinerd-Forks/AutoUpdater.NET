...
namespace AutoUpdaterDotNET
{
	...
	{
		public RemindLaterForm() { InitializeComponent(); }
		...
		private void RadioButtonYesCheckedChanged(object sender, EventArgs e) { comboBoxRemindLater.Enabled = radioButtonYes.Checked; }
	}
}
